  ...
  return (
    <div className="min-h-screen pt-16 pb-10 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-6">About PackWave</h1>
          ...
          <div className="md:col-span-2 mt-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-card p-6 rounded-lg shadow-md border border-border">
                <h3 className="text-xl font-medium text-accent mb-2">Integrity</h3>
              ...
              <div className="bg-card p-6 rounded-lg shadow-md border border-border">
                <h3 className="text-xl font-medium text-accent mb-2">Customer & People First</h3>
                <p className="text-muted-foreground">
              ...
              <div className="bg-card p-6 rounded-lg shadow-md border border-border">
                <h3 className="text-xl font-medium text-accent mb-2">Hard Work & Quality</h3>
                <p className="text-muted-foreground">
